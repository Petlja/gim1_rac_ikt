...
Напознатији формати за архивирање података су .zip и .rar. a програми за архивирање WinZip, Win RAR и компримовање директно у ОС Виндоуз командом "Пошаљи у... Компримована (зипована) фасцикла" (енгл. Send to... Compressed (zipped) folder") која се налази у менију добијеном десним кликом на датотеке које се пакују. Они компресују читаве фасцикле у једну датотеку која заузима мање меморије него све датотеке заједно пре паковања. Степен компресије није за све врсте датотека исти. 
