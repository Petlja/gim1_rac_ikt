...
- нумерисане и тада редови започињу редним бројевима или словима из којих следи обично тачка или затворена заграда.

- са више нивоа, најчешће је то комбинација нумерисаних листа са бројевима и словима (попут нумерације на пример у збирци задатака из математике, где су побројани задаци, а у сваком имамо варијанте под а, б, в, г...)
